  ...
  return (
    <div className="w-96 h-[760px] rounded-[20px] overflow-hidden shadow-lg bg-[#2A2A34]  m-4">
      ...
      <div className="p-4 mt-4 text-center flex flex-col">
        <span className="text-lg font-bold text-white">R$99,90<span className="text-sm">/mês</span></span>
        <span className="text-lg font-bold text-white">R$999,90<span className="text-sm text-blue">/ano</span></span>
      </div>
      <div className=" gap-2 flex flex-col items-center">
        <div className="flex items-center text-green-500 my-2">
          <FaCheckCircle />
          <span className="ml-2">3 usuário(s)</span>
        </div>
        <div className="flex items-center text-green-500 my-2">
          <FaCheckCircle />
          <span className="ml-2">300 processos</span>
        </div>
        <div className="flex items-center text-green-500 my-2">
          <FaCheckCircle />
